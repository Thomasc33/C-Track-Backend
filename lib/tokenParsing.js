    ...
    toUID(token) {
        return new Promise(async (res, rej) => {
            ...
            try {
                ...
                //query
                let resu = await pool.request().query(`SELECT id, is_archived FROM users WHERE email = '${email}'`)
    ...
    checkForAdmin(token) {
        return new Promise(async (res, rej) => {
            ...
            try {
                ...
                //query
                let resu = await pool.request().query(`SELECT id, is_admin, is_archived FROM users WHERE email = '${email}'`)
                    .catch(er => { return { isErrored: true, error: er } })
