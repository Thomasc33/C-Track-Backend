    ...
    function getUserData(id) {
        ...
        assetJobCodes.forEach(jc => {
            ...
            if (range) {
                ...
                // discrepancy check
                if (job_codes[jc].requires_asset) if ((Object.keys(tsheets_data) && ts_count !== count) || count !== snipe_count) discrepancies[id].push({ jc, ts_count, count, snipe_count, date, unique })
